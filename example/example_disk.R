...
devtools::install_github("kevincoakley/downloadtweets", ref = "0.4.0")
...
# Download tweets
download_tweets(consumerKey, consumerSecret, accessToken, accessTokenSecret, tweet_ids, 'example')
